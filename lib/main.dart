...
const TextStyle tituloPrincipal =TextStyle(fontSize: 30, color: colorContrasteClaro, fontWeight: FontWeight.bold);
const TextStyle tituloApartados =TextStyle(fontSize: 24, color: colorTextos, fontWeight: FontWeight.bold);
const TextStyle tituloApartadosAlter =TextStyle(fontSize: 20, color: colorTextosAlter, fontWeight: FontWeight.bold);
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String?>> experiencias = [
      {
        'apartado': 'Practicas: FP Dual Superior Desarollo de programación multiplataforma',
        'ubicacionYFecha': 'Cinfo, Mayo 2025 - Julio 2025',
        'descripcion': '- Desarollo de Página Web usando Angular,SpringBoot y Java\n- Aprendizaje de las Metodologías Agile y marco de trabajo Scrum'
      },
      {
        'apartado': 'Practicas: FP Superior Animaciones 3D, Videojuegos y Entornos Interactivos',
        'ubicacionYFecha': 'Digital Monster Collective, Mayo 2024 - Octubre 2024',
        'descripcion': '- Testeo de videojuegos\n- Participación en el desarollo de videojuegos para Game Jam'
      },
    ];
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: TextContainer(
                          titulo: 'Sobre Mi',
                          contenedor: 'Soy un joven estudiante, apasionado por la informática y los videojuegos desde niño. Mi meta es poder contar historias a través de los proyectos que haga',
                          estiloTitulo: tituloApartadosAlter,
                          estiloContenido: TextStyle(fontSize: 14, color: colorTextosAlter),
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Icon(
                                    _isTecnologiasExpanded ? Icons.expand_less : Icons.expand_more,
                            ...
                            if (_isTecnologiasExpanded) // Se muestra solo si está expandido
                              const Padding(
                                padding: EdgeInsets.only(top: 8.0), // Espacio entre el título y la lista
                                child: Text('Flutter\nDart\nJava\nSpringBoot\nAngular\nUnity\nC#', style: TextStyle(fontSize: 14, color: colorTextosAlter)),
                              ),
                          ],
                        ),
                      ),
                    ...
                    children: [
                      ...
                      ...estudios.map((estudio) {
                        return DrawerContainer(
                          ...
                          estiloUbicacionYFecha: const TextStyle(fontSize: 16, color: colorTextos, fontStyle: FontStyle.italic),
                          estiloDescripcion: const TextStyle(fontSize: 14, color: colorTextos),
